! function(e, t) {
    ...
    var b = (I.prototype.next = function(t) {
    ...
    function w() {}
    var O = (E.prototype.setInstantiationMode = function(e) {
    ...
    var _ = "[DEFAULT]",
        N = (C.prototype.get = function(e) {
            ...
            this.instancesDeferred.delete(e = void 0 === e ? _ : e), this.instancesOptions.delete(e), this.instances.delete(e)
            ...
            return this.instancesOptions.get(e = void 0 === e ? _ : e) || {}
    ...
    function x(a, t) {
        for (var e = 0, n = A; e < n.length; e++) ! function(e) {
            var o = null;
    ...
    function $(e, t, n) {
        var r = this;
        this.firebase_ = n, this.isDeleted_ = !1, this.name_ = t.name, this.automaticDataCollectionEnabled_ = t.automaticDataCollectionEnabled || !1, this.options_ = h(void 0, e), this.container = new S(t.name), this._addComponent(new O("app", function() {
            return r
    ...
    function Y(a) {
        var s = {},
            ...
            c = {
                ...
                registerVersion: function(e, t, n) {
                    ...
                    var i = r.match(/\s|\//),
                        e = t.match(/\s|\//);
                    i || e ? (n = ['Unable to register library "' + r + '" with version "' + t + '":'], i && n.push('library name "' + r + '" contains illegal characters (whitespace or "/")'), i && e && n.push("and"), e && n.push('version name "' + t + '" contains illegal characters (whitespace or "/")'), W.warn(n.join(" "))) : o(new O(r + "-version", function() {
                        return {
                            library: r,
                            version: t
                        }
        ...
        function o(n) {
            ...
            l.set(r, n), "PUBLIC" === n.type && (e = function(e) {
                if ("function" != typeof(e = void 0 === e ? u() : e)[r]) throw V.create("invalid-app-argument", {
                    appName: r
                });
                return e[r]()
    ...
    var q, Q, ee = H;
    (q = ee).INTERNAL.registerComponent(new O("platform-logger", function(e) {
        return new J(e)
    }, "PRIVATE")), q.registerVersion(B, "0.6.30", Q), q.registerVersion("fire-js", "");
    return ee.registerVersion("firebase", "8.10.0", "app"), ee.SDK_VERSION = "8.10.0", ee
});
